...
right_side_first=zero(1,t+1)    %first refers to the first element in the matrix on the right hand side
right_side_last=zero(1,t+1)     %last refers to the last element in the matrix on the left had side
